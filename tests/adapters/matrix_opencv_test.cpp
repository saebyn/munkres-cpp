...
TEST_F (Adapters_opencv_matrix_Test, solve_opencv_matrix_Success)
{
    ...
    munkres_cpp::matrix_opencv<double> etalon_opencv_matrix (dimension, dimension);
    //  {1.0,  0.0,  1.0},
    //  {0.0,  1.0,  1.0},
    //  {1.0,  1.0,  0.0}
    ...
    munkres_cpp::matrix_opencv<double> test_opencv_matrix (dimension, dimension);
    //  {9.0,  0.0,  9.0},
    //  {0.0,  9.0,  9.0},
    //  {9.0,  9.0,  0.0}
    test_opencv_matrix (0, 0) = 9.0; test_opencv_matrix (0, 1) = 0.0; test_opencv_matrix (0, 2) = 9.0;
    test_opencv_matrix (1, 0) = 0.0; test_opencv_matrix (1, 1) = 9.0; test_opencv_matrix (1, 2) = 9.0;
    test_opencv_matrix (2, 0) = 9.0; test_opencv_matrix (2, 1) = 9.0; test_opencv_matrix (2, 2) = 0.0;
